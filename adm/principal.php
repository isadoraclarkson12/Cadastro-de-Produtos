...
function cabecalho($title)
{
  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
      <ul class="navbar-nav mr-auto">
        ...
        <div class="dropdown-menu dropdown-default" aria-labelledby="navbarDropdownMenuLink-333">
          ...
          <a class="dropdown-item super" href="usuarios">Usuários</a>
        </div>
      </li>
    </ul>
    <ul class="navbar-nav ml-auto nav-flex-icons">
      ...
      <a class="dropdown-item" href="#" onclick="sair()">Sair</a>
    </div>
  </li>
</ul>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer" id="rodapeModal" style="border-top: none">
        ...
        <!-- <button type="button" class="btn btn-primary confirmarExc" data-id"'+$(this).attr('data-id')+'">Save changes</button> -->
      </div>
    </div>
  </div>
</div>
